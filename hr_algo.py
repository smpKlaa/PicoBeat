...
class HRA:
    ...
    def __init__(self, mode=None, display=None):
        """
        PARAMS:
        mode(int):	0 = Only Measure BPM (Default),
                    1 = Basic HRV analysis,
                    2 = Kubios HRV analysis
        ...
        # Loading screen
        self.OLED.fill(0)
        self.OLED.text("Initializing...", 0, 0, 1)	# DEBUG
        self.OLED.show()
